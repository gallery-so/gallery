    ...
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clip-path="url(#clip0_501_4356)">
        ...
        <path
          ...
          fill={fillColor}
        />
        <path d="M13.3333 0.666748H2.66663V2.76199H13.3333V0.666748Z" fill={fillColor} />

        <path d="M15.4667 4.8572H0.533333L0 2.76196H16L15.4667 4.8572Z" fill={fillColor} />
        <path d="M14.9333 4.85718H11.7333V13.2381H14.9333V4.85718Z" fill={fillColor} />
        <path
        ...
        <path
          ...
          fill={fillColor}
        />
        <path d="M4.26665 4.85718H1.06665V13.2381H4.26665V4.85718Z" fill={fillColor} />
        <path
