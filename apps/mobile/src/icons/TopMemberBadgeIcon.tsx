...
export function TopMemberBadgeIcon(props: SvgProps) {
  ...
  const fill = colorScheme === 'dark' ? colors.darkModeBlue : colors.activeBlue;
  const stroke = colorScheme === 'dark' ? colors.black.DEFAULT : colors.white;
  return (
    <Svg width={24} height={24} fill="none" {...props}>
      <G clipPath="url(#a)">
        <Path fill={fill} d="m17.06 13.34 3.44 6.16H17l-1.5 3-3.5-6-3.5 6-1.5-3H3.5l3.44-6.16" />
        <Path
          stroke={stroke}
          d="m17.06 13.34 3.44 6.16H17l-1.5 3-3.5-6-3.5 6-1.5-3H3.5l3.44-6.16"
        />
        <Path fill={fill} stroke={stroke} d="M12 15.5a7 7 0 1 0 0-14 7 7 0 0 0 0 14Z" />
        <Path
          fill={stroke}
      ...
      <Defs>
        <ClipPath id="a">
          <Path fill={stroke} d="M0 .5h24v23H0z" />
        </ClipPath>
      </Defs>
    </Svg>
  );
