...
describe('processIFrameRenderUrl', () => {
  describe('youtube', () => {
    it('handles youtube URLs', () => {
      ...
      expect(result).toEqual('https://www.youtube.com/embed/FthSdzBltP4?autoplay=1');
    });
    ...
    it('handles youtube URLs with params', () => {
      ...
      expect(result).toEqual('https://www.youtube.com/embed/FthSdzBltP4?chain=ethereum&autoplay=1');
    });
